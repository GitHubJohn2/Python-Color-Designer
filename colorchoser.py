...
compcode = StringVar()
compcode.set("#000000")
mixcolor = "#000000"  # will need this when we go to color our frame
...
redscale = Scale(bigframe, from_=0, to=255, orient=HORIZONTAL, length=255, bg="#880000", command=redchg, digits=0,
                 sliderlength=20, troughcolor="white", label="Red Select Scale", bd=8, relief="sunken")
...
greenscale = Scale(bigframe, from_=0, to=255, orient=HORIZONTAL, length=255, bg="#008800", command=greenchg, digits=0,
                   sliderlength=20, troughcolor="white", label="Green Select Scale", bd=8, relief="sunken")
...
bluescale = Scale(bigframe, from_=0, to=255, orient=HORIZONTAL, length=255, bg="#000088", command=bluechg, digits=0,
                  sliderlength=20, troughcolor="white", label="Blue Select Scale", bd=8, relief="sunken")
